...
export function SessionRedirectPage() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-canvas px-4">
      <Card className="max-w-xl border border-line/70 bg-surface/90 shadow-panel">
        <CardContent className="gap-5 p-8 text-center">
          <p className="text-xs uppercase tracking-[0.22em] text-muted">Admin Session</p>
          ...
          <Button variant="primary" onPress={() => window.location.replace("/#/login")}>
