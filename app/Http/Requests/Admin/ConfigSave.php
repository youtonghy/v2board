...
class ConfigSave extends FormRequest
{
    const RULES = [
        ...
        'invite_force' => 'in:0,1',
        'register_mode' => 'in:0,1,2',
        'invite_commission' => 'integer',
        'invite_gen_limit' => 'integer',
        'invite_never_expire' => 'in:0,1',
        'invite_admin_only' => 'in:0,1',
        'user_invite_page_enable' => 'in:0,1',
        'public_register_enable' => 'in:0,1',
        'invite_link_default_max_use' => 'integer|min:1',
        'invite_link_default_expire_hours' => 'integer|min:1',
        'invite_link_stats_enable' => 'in:0,1',
