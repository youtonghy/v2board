...
class AdminRoute
{
    public function map(Registrar $router)
    {
        $router->group([
            ...
            $router->post('/config/telegram/broadcast', 'V1\\Admin\\ConfigController@telegramBroadcast');
            ...
            $router->get ('/user/inviteLink/fetch', 'V1\\Admin\\UserController@fetchInviteLinks');
            $router->post('/user/inviteLink/updateStatus', 'V1\\Admin\\UserController@updateInviteLinkStatus');
            ...
            $router->get ('/stat/getTodayTrafficOverview', 'V1\\Admin\\StatController@getTodayTrafficOverview');
            // Notice
